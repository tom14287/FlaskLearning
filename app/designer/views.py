...
@login_required
def designer_index():
    return render_template("designer.html", user_name='dyftug',Type = g.user.UserType)
...
def designer_design_scheme():
	...
	return render_template("designer_scheme.html", design=design,Type = g.user.UserType)
...
def designer_orders():
    ...
    for item in schemes:
        ...
        design.append(temp)
    print design
    return render_template("designer_order.html", design=design,Type = g.user.UserType)
...
def designer_scheme(id):
    ...
    return render_template('scheme.html', scheme=scheme, comments=comments, scheme_imgs=scheme_imgs, designer=designer,Type = g.user.UserType)
