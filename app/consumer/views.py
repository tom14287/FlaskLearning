...
def consumer_index():
	...
	'''
	return render_template("consumer.html", user_name='dyftug',Type = g.user.UserType)
...
def consumer_change_info():
	...
	return render_template('consumer_profile.html',Type = g.user.UserType)
...
def consumer_cart():
	...
	for item in goods:
		...
		items.append(temp)
	return render_template('cart.html', items=items, subtotal='$'+str(total), total='$'+str(total),Type = g.user.UserType)
...
def consumer_orders():
	...
	return render_template('consumer_order.html', unpay=unpay, unpay_num=unpay_num, review=review, review_num=review_num ,finish=finish, finish_num=finish_num, Type = g.user.UserType)
...
def consumer_decoration():
	...
	for item in dec_forms:
		...
		command.append(temp)
	return render_template('consumer_decoration.html',command=command,Type = g.user.UserType)
